...
export class AuthRouter {
  ...
  constructor(
    ...
    this.initializeRoutes();
       ...
       // Service repository
       const userTokenServiceRepository = new UserTokenService(userTokenRepository);
       const hostTokenServiceRepository = new HostTokenService(hostTokenRepository);
    this.authMiddleware = new AuthMiddleware(hostTokenServiceRepository, userTokenServiceRepository)
  }
  ...
  private initializeRoutes(): void {
    ...
    this.router.post("/users/logout", this.authMiddleware.userAuth ,(req, res, next) =>
